...
class JointFailSACData:
    ...
    def set_color_codes(self, grouping, **kwargs):
        """
        Set color codes for groupings. grouping must be a key in data.
        """
        pass
...
if __name__ == "__main__":
    ...
    --- exp_dir
    """
    d = JointFailSACData(['joint_failure_prob', ['policy_kwargs', 'value', 'actor_cspn_args']])
